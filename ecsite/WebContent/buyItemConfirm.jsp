	...
	<div id="main">
		...
		<div>
			<s:form id="form">
				...
				<tr>
					<td><s:submit theme="simple" value="戻る" onclick="goHomeAction();"/></td>
					<td><s:submit theme="simple" value="完了" onclick="goBuyItemConfirmAction();"/></td>
				</tr>
			</s:form>
			<div>
